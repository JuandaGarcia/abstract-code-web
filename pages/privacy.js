			...
			<section className="web-dev">
				...
				<div className="container-privacy">
					<p className="privacy-text">
						...
						Abstract Code usa y protege la información que es proporcionada por
					...
					<br />
					<p className="privacy-text">
						Abstract Code está altamente comprometido para cumplir con el
					...
					<p className="privacy-text">
						...
						visitas a una web . Usted puede aceptar o negar el uso de cookies,
						sin embargo la mayoría de navegadores aceptan cookies
						automáticamente pues sirve para tener un mejor servicio web. También
						usted puede cambiar la configuración de su ordenador para declinar
					...
					<br />
					<p className="privacy-text">
						Abstract Code Se reserva el derecho de cambiar los términos de la
